...
import br.com.wallet.security.JwtAuthenticationEntryPoint;
import br.com.wallet.security.JwtAuthenticationTokenFilter;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter{
    ...
    protected void configure(HttpSecurity http) throws Exception{
    	http.csrf().disable().exceptionHandling().authenticationEntryPoint((AuthenticationEntryPoint) unauthorizedHandler)
